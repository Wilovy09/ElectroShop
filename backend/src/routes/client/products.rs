use crate::{models::product::Product, params::{category::PartialCategoryParams, product::PartialProductParams}, responses::message::Messages, AppState};
use actix_web::{
    get,
    web::{self, Data},
    HttpResponse,
...
pub fn config(cfg: &mut web::ServiceConfig) {
    cfg.service(get).service(get).service(find).service(find_by_category);
}
...
async fn find_by_category(state: Data<AppState>, param: web::Path<PartialCategoryParams>) -> HttpResponse {
